...
const EXPECTED_DAEMON_NAME: &str = "toyciety-code-daemon";
...
const APP_IDENTIFIER: &str = "com.toyciety.code";
...
LISTEN 0      4096   0.0.0.0:4732      0.0.0.0:*    users:(("toyciety-code-da",pid=12345,fd=7))
"#;
...
tcp        0      0 0.0.0.0:4732            0.0.0.0:*               LISTEN      6789/toyciety-code-da
"#;
