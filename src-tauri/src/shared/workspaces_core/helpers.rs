...
mod tests {
    ...
    fn make_temp_dir() -> std::path::PathBuf {
        let dir = std::env::temp_dir().join(format!("toyciety-code-{}", Uuid::new_v4()));
    ...
    fn workspace_path_to_string_strips_windows_namespace_prefixes() {
        assert_eq!(
            workspace_path_to_string(&PathBuf::from(r"\\?\I:\gpt-projects\ToycietyCode")),
            r"I:\gpt-projects\ToycietyCode"
        );
    }
}
