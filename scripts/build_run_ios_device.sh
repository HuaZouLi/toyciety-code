...
APP_PATH="src-tauri/gen/apple/build/arm64/Toyciety Code.app"
if [[ ! -d "$APP_PATH" ]]; then
  APP_PATH="$(find src-tauri/gen/apple/build -maxdepth 4 -type d -name 'Toyciety Code.app' | head -n 1 || true)"
fi
