...
app_path="${1:-src-tauri/target/release/bundle/macos/Toyciety Code.app}"
...
bin_path="${app_path}/Contents/MacOS/toyciety-code"
daemon_path="${app_path}/Contents/MacOS/toyciety_code_daemon"
daemonctl_path="${app_path}/Contents/MacOS/toyciety_code_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/toyciety_code_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/toyciety_code_daemonctl}"
